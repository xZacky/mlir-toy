    ...
    mlir::LogicalResult matchAndRewrite(mlir::Operation *op,
        ...
        lowerOpToLoops(
            ...
            [loc](mlir::OpBuilder &builder, mlir::ValueRange memRefOperands,
                  mlir::ValueRange loopIvs) {
                // Generate an adaptor for the remapped operands of the BinaryOp.
                ...
                // loop.
                auto loadedLhs = builder.create<mlir::affine::AffineLoadOp>(loc,
                    binaryAdaptor.getLhs(), loopIvs);
                auto loadedRhs = builder.create<mlir::affine::AffineLoadOp>(loc,
                    binaryAdaptor.getRhs(), loopIvs);
