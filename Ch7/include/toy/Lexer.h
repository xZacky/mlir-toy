...
public:
    ...
    // Return the current cloumn in the file
...
private:
    ...
    /// The last Token read form the input.
    ...
    /// If the current Token is a number, this string contains the value.
    double numVal = 0;
    ...
    /// Buffer supplied by the derived class on calls `readNextLine()`.
    llvm::StringRef curLineBuffer = "\n";
};

/// A Lexer impelemention operating on a buffer in memory.
