...
//
// This file implements full lowering of Toy operations to LLVM IR dialect.
...
public:
    ...
    LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value>operands,
        ...
        auto printOp = llvm::cast<toy::PrintOp>(op);
        auto elementLoad = 
...
private:
    /// Return a symbol refenence to the printf function, inserting it to the
    /// module if necessary.
...
/// Create a pass for lowering operations the remaining `Toy` p[erations, as
